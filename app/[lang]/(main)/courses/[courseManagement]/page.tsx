...
console.log(courseItems?.courseId);
  ...
  const schema = useMemo(() => {
    return yup.object({
      coverId: yup.string().required(t("F_EntekhabElzami")),
      title: yup.string().required(t("F_EntekhabElzami")),
      description: yup.string().required(t("F_EntekhabElzami")),
      languageId: yup.string().required(t("F_EntekhabElzami")),
      rankId: yup.string().required(t("F_EntekhabElzami")),
    });
  }, [t]);
